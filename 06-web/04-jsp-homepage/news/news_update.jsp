...
%>		
	...
	<script type="text/javascript">
		function goSave(){
			if(isEmpty(news.t_title,"제목 입력")) return;
			if(isEmpty(news.t_content,"내용 입력")) return;
			news.method="post";
	  ...
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			<table class="bord_table">
				...
				<tbody>
					<tr class="first">
						<th>제목</th>
						<td colspan="3"><input type="text" name="t_title" value="<%=CommonUtil.getDoubleQuot(dto.getTitle())%>"></td>
					</tr>
					<tr>
						<th>내용</th>
			...
			<div class="btn_wrap">
				...
				<input type="reset" value="다시쓰기" onclick="location.href='news_write.jsp'" class="btn_reset">&nbsp;&nbsp;
